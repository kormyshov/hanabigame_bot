...
GAME_FAILED = '{} has got the last live'
...
PLAYER_HINT_COLOR_TO_YOU = '{} has hint you have "{}" with numbers {}'
PLAYER_HINT_COLOR_TO_OTHER = '{} has hint that {} has "{}" with numbers {}'
PLAYER_HINT_VALUE_TO_YOU = '{} has hint you have "{}" with numbers {}'
PLAYER_HINT_VALUE_TO_OTHER = '{} has hint that {} has "{}" with numbers {}'
